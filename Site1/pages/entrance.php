...
echo '<h4>Hello, <span>'.$_SESSION['registered_user'].'</span>&nbsp;';
...
if(isset($_GET['page'])) echo '?page='.$_GET['page'].'" ';
echo 'class="form-inline float-right" method="post">';
echo '<input class="form-control mr-sm-2" type="text" placeholder="Введите логин" aria-label="Login" name="auth_log">
      <input class="form-control mr-sm-2" type="text" placeholder="Введите пароль" aria-label="Login" name="auth_pas">
